...
async def generate_pdf(
    ...
    concept_html = html_dir / f"concept_{target}.html"
    book_html = html_dir / f"book_{target}.html"
    ...
    pdf_file = pdf_dir / f"{kind}_{target}.pdf"
    ...
    rel_path = f"output/{variant}/{model_seg}pdf/{kind}_{target}.pdf"
